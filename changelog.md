...
* __[maintenance]__
Update dependency `semver` to 7.7.3.

## Version 7.0.11 (2025-10-07)

* __[maintenance]__
Update dependency `detect-libc` to 2.1.2.

* __[maintenance]__
Update dependency `node-abi` to 3.78.0.
...
* __[maintenance]__
Update dependency `node-abi` to 3.77.0.

## Version 7.0.8 (2025-08-19)

* __[maintenance]__
Update dependency `canvas` to 3.2.0.

## Version 7.0.7 (2025-06-27)

* __[maintenance]__
Update dependency `canvas` to 3.1.2.

## Version 7.0.6 (2025-06-24)

* __[maintenance]__
Update dependency `canvas` to 3.1.1.
...
* __[maintenance]__
Update dependency `detect-libc` to 2.0.4.

* __[maintenance]__
Update dependency `node-abi` to 3.75.0.
...
* __[maintenance]__
Update dependency `node-abi` to 3.74.0.

* __[maintenance]__
Update dependency `semver` to 7.7.0.
